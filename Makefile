##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.9.0-B19] date: [Sat May 30 11:20:08 CEST 2026] 
##########################################################################################################################
...
# IMU transport selection. Override at the command line:
#   make IMU_BUS=SPI
#   make IMU_BUS=I2C   (default)
IMU_BUS ?= I2C
ifeq ($(IMU_BUS),SPI)
...
CPP_SOURCES += Core/Src/ahrs/impl/mpu9250/imu_i2c.cc \
               Core/Src/ahrs/impl/mpu9250/io_i2c.cc
C_SOURCES   += Core/Src/i2c.c \
               Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_i2c.c
IMU_BUS_DEFS := -DIMU_USE_SPI=0 -DIMU_USE_I2C=1
else
$(error IMU_BUS must be SPI or I2C, got '$(IMU_BUS)')
endif
