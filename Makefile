##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.10.0-B28] date: [Mon Aug 31 23:40:53 CEST 2026] 
##########################################################################################################################
...
#   make IMU_BUS=SPI (default) - MPU-9250 on SPI1 (PA5/6/7 + PB0 CS).
...
$(error IMU_BUS=I2C is not supported: the CubeMX project was regenerated for SPI (Core/Src/i2c.c and Core/Inc/i2c.h were removed))
else
